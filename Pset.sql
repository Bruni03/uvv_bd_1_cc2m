...
-- Conexão ao banco uvv com o usuário lucas:
\c "dbname=uvv user=lucas password=1007"
...
CREATE TABLE localizacoes_departamento (
    numero_departamento INT CONSTRAINT nn_local_dept_num_dept NOT NULL,
    local VARCHAR(15) CONSTRAINT nn_local_dept_local    NOT NULL
);
...
ALTER TABLE localizacoes_departamento ADD CONSTRAINT fk_numero_dept_numero_dept
FOREIGN KEY (numero_departamento) REFERENCES departamento (numero_departamento);

-- Cria a tabela projeto:
CREATE TABLE projeto (
    numero_projeto INT CONSTRAINT nn_proj_numero_proj  NOT NULL,
    nome_projeto VARCHAR(15) CONSTRAINT nn_proj_nome_proj NOT NULL,
    local_projeto VARCHAR(15),
    numero_departamento INT CONSTRAINT nn_proj_numero_dept NOT NULL
);
...
ALTER TABLE projeto ADD CONSTRAINT fk_proj_numero_dept_numero_dept
FOREIGN KEY (numero_departamento) REFERENCES departamento (numero_departamento);
...
CREATE TABLE trabalha_em (
    cpf_funcionario CHAR(11) CONSTRAINT nn_trabalha_em_cpf NOT NULL,
    numero_projeto  INT CONSTRAINT nn_trabalha_em_numero_proj NOT NULL,
    horas           DECIMAL(3,1)
);
...
INSERT INTO funcionario (primeiro_nome, nome_meio, ultimo_nome, cpf, data_nascimento, endereco, sexo, salario, cpf_supervisor, numero_departamento) VALUES (
    'Pedro', 'R', 'sarmento', '12981734509', '1999-09-25', 'rua copo de leite,102,VV', 'M', 10505);
